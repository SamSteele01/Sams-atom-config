...
function validateQuery(ast, schema = null, customRules, isRelayCompatMode) {
    ...
    const deprecationWarningAnnotations = mapCat(graphql_1.findDeprecatedUsages(schema, ast), error => annotations(error, exports.DIAGNOSTIC_SEVERITY.Warning, 'Deprecation'));
